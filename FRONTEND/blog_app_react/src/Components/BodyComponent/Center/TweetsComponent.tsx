import image from "../../../../public/TweetImage.avif";
import { Element } from "./TweetsElements";

const TweetsComponent = () => {
  const styles1 = {
    margin:
      "height: 200px; background-image: url(https://images.unsplash.com/photo-1556740738-b6a63e27c4df?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=448&amp;q=80);",
  };
        ...
        <div className="pl-16">
          ...
          <div className="md:flex-shrink pr-6 pt-3">
            <div
              ...
              style={styles1}
            >
              <img className="image-sizing h-full w-50" src={image} alt="" />
              {/* <img
          ...
          <article className="hover:bg-gray-800 transition duration-350 ease-in-out">
            ...
            <div className="pl-16">
              ...
              <div className="md:flex-shrink pr-6 pt-3">
                ...
                >
                  <img
                    className="image-sizing h-full w-50"
                    src={image}
                    alt=""
                  />
                  {/* <img
